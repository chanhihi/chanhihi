...
- 실시간 데이터 환경에서의 성능 및 안정성 개선(Instruments 활용)
- Metric 메타 구조체 및 자료구조 개선으로 메모리 사용량 약 **1/10 수준 절감**
- 앱 최소 구동 사양을 **A16 → A14 iPad까지 확장**하여 비용 절감 및 매출 기여
- 신규 Metric 추가 시 DB/로직 수정 범위를 최소화하여 **확장성과 유지보수성 개선**
- 단기 기능 구현이 아닌 **장기 확장성과 성능 중심 구조 설계 주도**

</br>

### Experience Insight

- 실시간 데이터 환경에서 데이터 정확성과 UI 반응성 사이의 균형 설계 경험
- 성능 문제 해결 과정에서 데이터 구조 설계가 시스템 전반에 미치는 영향에 대한 이해
- 기능 추가보다 확장 가능한 구조 설계가 장기 유지보수에 더 중요함을 경험(기술적·데이터 확장성)
- 복잡한 데이터 흐름을 단순화하기 위한 상태 관리 구조 설계 경험
- 도메인 모델 설계가 코드 가독성과 확장성에 미치는 영향에 대한 이해
...
- 42서울 학생들을 위한 웹 서비스 통합 플랫폼 앱 개발
- WKWebView 기반 Web ↔ macOS 브릿지 통신 구조 구현
- Web 자산을 활용한 데스크탑 환경 최적화
- [📎 42 Box macOS Github](https://github.com/42Box)

</br>

### 📱 42Box iOS (2024.04 ~ 2024.07)

- macOS 앱을 iOS 환경에 맞게 마이그레이션 및 배포
- 링크 저장 및 폴더 기반 관리 기능 구현
- WKWebView 기반 Web ↔ iOS Native 간 데이터 흐름 및 이벤트 처리 구조 설계
- [📎 42 Box iOS Github](https://github.com/42Box/iOS)
- [🍏 42 Box Appstore Link](https://apps.apple.com/in/app/42box/id6499335551)

</br>

### 🐦‍⬛ Swift/C++ Problem Solving (Algorithm)

- 2025년 1월 22일 기준, Swift로 543문제, C++17로 219문제의 알고리즘 문제 해결
- 자료구조 및 시간복잡도 기반 문제 해결 역량 강화
...
- SceneKit 기반 3D 단백질 시각화 프로젝트 개발
- Tuist 기반 모듈 분리 및 레이어 구조 설계
- 객체지향 설계를 기반으로 구조 설계 경험
...
- open-meteo SDK Swift 기여
- OpenAPI 기반 데이터 처리 및 SDK 구조 이해
...
- [📎 Calculator App + Expression](https://github.com/chanheki/mobileModule00)
- [📎 Delivery App](https://github.com/PPang-Delivery/PPang-Delivery)
...
- 23년 부터 클라이언트 개발자로 전향 후 메인테이너로써 활동하여 [프론트엔드](https://github.com/jiphyeonjeon-42/frontend)에 직간접적으로 도움을 주고 있습니다.
- [🌐 42 도서관 집현전 서비스 바로가기](https://42library.kr/)

</br>

### 생성형 AI를 사용하여 편지 형태로 나타낸 유저 맞춤형 기록 서비스 [심심조각](https://www.dear-my-peace.site/)(2022.09-2024.07)
...
- ARM Cortex-M0+ 기반 베어메탈 환경에서 펌웨어 설계 및 개발
- Infineon PSoC4 MCU 초기화 및 주변장치 제어
- BLE 기반 모바일 앱 연동 및 독자 프로토콜 설계/구현
- C# WinForms 기반 테스트 툴 개발 및 통신 테스트 환경 구축
- HW–FW–App 간 연동 구조 설계 및 디버깅 경험

</br>

### Project & Impact

- 스마트워치 디바이스의 펌웨어 개발 및 BLE 연동 테스트
- 캠핑카 터치 컨트롤 패널 시스템 개발
- 적외선(IR) 리모트 컨트롤러 개발 및 검증
- TPMS 테스트 툴 개발

</br>

### Experience Insight
- 제한된 리소스 환경에서의 시스템 안정성 및 메모리 관리
- BLE 통신 디버깅 및 실시간 데이터 처리 경험
- HW–SW 통합 관점의 문제 해결 능력
- 디자이너 협업 경험 (Zeplin)
...
<details>
<summary><h2>42Seoul 7th cadet (2022.07 - 2024.07)</h2></summary>
